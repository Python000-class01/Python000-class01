####################
# 《饥饿站台》剧评
# https://movie.douban.com/subject/34805219/comments?start=0&limit=20&sort=time&status=P
...
urls = tuple(
    f'https://movie.douban.com/subject/34805219/comments?start={ page * 20 }&limit=20&sort=new_score&status=P' for page in range(10))  # 把所有url存在元组中
