...
def main():
    ...
    parser.add_argument('-n', dest='threads_number', type=int,
                        help='number of threads')
    parser.add_argument('-f', dest='mode', type=str,
                        help='ping for ip scan, tcp for port detect')
    parser.add_argument('-ip', dest='ip_range', type=str,
                        help='ip range to check, e.g:192.168.0.1-192.168.0.100')
    parser.add_argument('-w', dest='output', type=str,
                        help='output file name')

    arguments = parser.parse_args()
    num_threads = arguments.threads_number
    mode = arguments.mode
