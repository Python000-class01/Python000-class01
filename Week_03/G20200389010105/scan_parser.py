...
class MyScan_Input(object):
    ...
    def get_argsparser_result(self):
        ...
        parser.add_argument(
            ...
            dest='save',
            type=str,
            help='Save the result for Json format to a file')
        return parser
...
class MyScan_Ping(object):
    ...
    def ping_test(self, host_ip):
        ...
        symbol = True if bool(result) else False
        print(f'ping {host_ip} 测试结束。')
        return f'Ping测试结果: {symbol}'
