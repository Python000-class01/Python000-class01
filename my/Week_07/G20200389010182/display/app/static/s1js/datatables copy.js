...
$(document).ready(function() {
    $("#datatable").DataTable({
        ...
        ajax: function (data, callback, settings) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    returnData.data = arr.data.news;//返回汽车列表
        ...
        columns: [
            ...
            {"data": "desc", "width": "50px", "defaultContent": "<i></i>"},
            {"data": "sentiment", "width": "120px", "defaultContent": "<i></i>"},
            {"data": "event_time", "width": "80px", "defaultContent": "<i></i>"},
            {"data": "collect_time", "width": "80px", "defaultContent": "<i></i>"},
            ]
        })
    })